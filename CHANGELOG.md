## [0.30.0](https://github.com/marco0560/Fontshow/compare/v0.29.3...v0.30.0) (2026-02-06)

### Features

* add strict semantic validation mode to create-catalog ([27dbce1](https://github.com/marco0560/Fontshow/commit/27dbce153b4580f087388fc72c6ea8686805a04b)), closes [#47](https://github.com/marco0560/Fontshow/issues/47)
* **catalog:** aggregate missing language coverage + ratio-based severity in create_catalog ([75a1287](https://github.com/marco0560/Fontshow/commit/75a1287894307ce7a7d32496fd68c7089cf6e8c9)), closes [#4](https://github.com/marco0560/Fontshow/issues/4)
* **parser:** add strict_bcp47 to test namespace ([c3fabf4](https://github.com/marco0560/Fontshow/commit/c3fabf4fd473db91db10dc0e3182cb450047777b))
* **parser:** clarify semantic validation scope for language codes ([8dea9fe](https://github.com/marco0560/Fontshow/commit/8dea9fe72e643add20bcb4cb918b49f4712e072e))
* **parser:** clarify semantic validation scope for language codes ([ee3a2f8](https://github.com/marco0560/Fontshow/commit/ee3a2f8e30177f2b06abaf7b6ab0e6471ce7f2bf))
* **parser:** normalize languages and track dropped entries ([e2e6578](https://github.com/marco0560/Fontshow/commit/e2e6578372717b47e3e279e8c39c3c9916d9a1b0))
* **parser:** normalize languages and track dropped entries ([741f94c](https://github.com/marco0560/Fontshow/commit/741f94c731a4873ef83f2eed7d1d97b6f28818f1))
* **parser:** structured language normalization & grouped warnings ([5f79907](https://github.com/marco0560/Fontshow/commit/5f799070626bbad6901353a8af96cfe819d924fb))

### Bug Fixes

* **build:** remove secondary CLI entrypoint ([7a2344a](https://github.com/marco0560/Fontshow/commit/7a2344aed731e89428c372e098b6a047a124c093))
* **catalog:** accept schema_version 1.1 in create-catalog ([51befa4](https://github.com/marco0560/Fontshow/commit/51befa4faa8b5d13334b67f3ed1c0d57bbd8267d))
* **catalog:** add inventory coverage diagnostics (non-intrusive) ([d10b912](https://github.com/marco0560/Fontshow/commit/d10b9128b2370b57a9f70d0f3c1eace527edaf19)), closes [#29](https://github.com/marco0560/Fontshow/issues/29)
* **catalog:** enforce strict semantic validation on full inventory ([d6b9321](https://github.com/marco0560/Fontshow/commit/d6b9321833e60778795dc6ae7584764b509972e5)), closes [#49](https://github.com/marco0560/Fontshow/issues/49)
* **catalog:** silence misleading warnings in legacy font detection ([50adb03](https://github.com/marco0560/Fontshow/commit/50adb035326679a574a0e2d8d52b45328f75c69f))
* **catalog:** use module-level quiet flag instead of args in helpers ([fabb953](https://github.com/marco0560/Fontshow/commit/fabb953364bcf00bbe629d209044f528bddaea32))
...
* **cli:** align quiet/verbose behavior and document via tests ([af447f6](https://github.com/marco0560/Fontshow/commit/af447f68d3045d720bc57bf6520724ab61734827))
* **cli:** centralize console logging and enforce stdout/stderr semantics ([cc6c228](https://github.com/marco0560/Fontshow/commit/cc6c2285c6c7cc9c8ad21f6b47db1bd63d8dfeb9))
* **cli:** enforce verbosity semantics for parse-inventory ([9a01344](https://github.com/marco0560/Fontshow/commit/9a01344cde7574ddd0677ffa60959bd997feb33a))
* **cli:** improve parse-inventory warning output with schema-aware font identity ([792770b](https://github.com/marco0560/Fontshow/commit/792770b00e00ade59243da66849711c1fc27755c))
...
* **cli:** normalize warning output and remove non-ASCII symbols for Windows consoles ([859efcf](https://github.com/marco0560/Fontshow/commit/859efcfd10574041af614cb86fc7ec1dcf9eeb34))
* **core:** phase 2 (TC) mechanical fixes + formatter stabilization ([2c1fe91](https://github.com/marco0560/Fontshow/commit/2c1fe9119ace3be53f8e7d2fdfcc2e2b2b406099))
* **core:** phase 3 (PTH) pathlib migration + runtime regression fixes ([b5faaac](https://github.com/marco0560/Fontshow/commit/b5faaace3a5c21122be683817030ea7035f4a8d0))
* **dump:** make fontTools optional dependency safe (fallback types) ([0ac82a0](https://github.com/marco0560/Fontshow/commit/0ac82a071c449c48151cc62e87a106f8d6aa8e56))
* **dump:** normalize missing style and exclude non-OpenType fonts ([3588ef4](https://github.com/marco0560/Fontshow/commit/3588ef4e0f6b804fc812c572ea9bba68929d6a49))
* **dump:** skip non-OpenType fonts and improve verbose summary ([163d10b](https://github.com/marco0560/Fontshow/commit/163d10b21839232c38940bd5dae641e3bd367e66))
* **output:** suppress normalization logs when no effective change occurs ([1aa5069](https://github.com/marco0560/Fontshow/commit/1aa50698fcc7906a555336d037d03606ffa3502b))
* **parser:** align field access with identity-based schema ([1b1566f](https://github.com/marco0560/Fontshow/commit/1b1566f3f630d29faadf19420149823aa9ca7c59))
* **parser:** clarify validation errors for identity fields ([ad42cb5](https://github.com/marco0560/Fontshow/commit/ad42cb51299fd61b9a2cbd8aee755ca33b70999b))
* **parser:** correct language normalization, deduplication, and warning emission ([a400d16](https://github.com/marco0560/Fontshow/commit/a400d169a5bcb46f4fc6009860078d8340006378))
* **parser:** make deprecated mappings explicit ([cf8be85](https://github.com/marco0560/Fontshow/commit/cf8be85fec33c3f4c2ee4792a5de0b334a50cfea))
* **schema:** add languages_raw field to inventory schema ([dce43bb](https://github.com/marco0560/Fontshow/commit/dce43bbb1e80049cccf8bc1489c0ed09d4f21ea4))
* **schema:** stabilize inventory validation and regression tests ([a1561c2](https://github.com/marco0560/Fontshow/commit/a1561c28ab1a451cb843a18e281acfd188b863ca))
* **schema:** stabilize inventory validation and regression tests ([8b345b0](https://github.com/marco0560/Fontshow/commit/8b345b01b521d0c6913ca26a59fa40fa1334fc6a))
* **validation:** enforce correct semantics for identity and base_names ([3a88ccc](https://github.com/marco0560/Fontshow/commit/3a88ccccc401b99b266a03f0477790404c6f397d)), closes [#48](https://github.com/marco0560/Fontshow/issues/48)
* **validation:** repair CLI rendering and exit path in __main__ ([4e7194f](https://github.com/marco0560/Fontshow/commit/4e7194ff81e255fef7e3ddb9a4438d47c8a6c181))
