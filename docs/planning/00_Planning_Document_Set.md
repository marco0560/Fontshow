# Fontshow — Planning Document Set Proposal (Base-Zero)

This document lists the proposed planning and governance documents
to support the new base-zero roadmap. Each document is described
by title, function, and a one-line content summary.

Approval of this set is required before documents are drafted.
