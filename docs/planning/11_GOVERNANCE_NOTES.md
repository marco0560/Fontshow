...
**Applies to:** Project planning, technical decisions, and contributions
...
- **Explicit decisions**
  Important decisions must be recorded and discoverable.

- **Traceability**
  Decisions should be traceable to context, rationale, and consequences.

- **Minimal process**
  Governance should support development, not obstruct it.
...
This governance model is **active**
and applies to all planning and decision-making
