...
_FONTSHOW_OPTIONS_CREATE_CATALOG="--help --inventory --list-test-fonts --number --output --quiet --test --test-font --validate-loadability --verbose --version -T -V -h -i -l -n -o -q -t -v"
_FONTSHOW_PATH_OPTIONS_CREATE_CATALOG="--inventory --output -i -o"
_FONTSHOW_POSITIONAL_PATH_CREATE_CATALOG=0

_FONTSHOW_OPTIONS_DUMP_FONTS="--cache-dir --help --include-fc-charset --no-cache --output --quiet --verbose --version -V -c -h -i -n -o -q -v"
