...
_FONTSHOW_OPTIONS_CREATE_CATALOG="--catalog-detail --help --indexed-navigation --inventory --list-test-fonts --number --output --quiet --test --test-font --verbose --version -T -V -h -i -l -n -o -q -t -v"
_FONTSHOW_PATH_OPTIONS_CREATE_CATALOG="--inventory --output -i -o"
_FONTSHOW_POSITIONAL_PATH_CREATE_CATALOG=0

_FONTSHOW_OPTIONS_DUMP_FONTS="--cache-dir --help --include-fc-charset --no-cache --no-loadability --output --quiet --verbose --version -V -c -h -i -n -o -q -v"
_FONTSHOW_PATH_OPTIONS_DUMP_FONTS="--cache-dir --output -c -o"
_FONTSHOW_POSITIONAL_PATH_DUMP_FONTS=0

_FONTSHOW_OPTIONS_PARSE_INVENTORY="--help --infer-level --list-missing-language-coverage --output --quiet --strict-bcp47 --validate-inventory --verbose --version -I -V -h -i -o -q -s -v"
